...
status = {-1: 'Compile Error', 0: 'Accepted', 1: 'Wrong Answer', 2: 'Runtime Error', 3: 'CPU Limit Exceeded', 4: 'Memory Limit Exceeded', 5: 'Idleness Limit Exceeded', -2147483648: 'Contact Staff', -2: 'Hacking Attempt Detected'}
